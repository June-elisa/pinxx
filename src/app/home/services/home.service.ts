...
export class HomeService {
  ...
  imageSliders: ImageSlider[] = [
    {
      imgUrl:
        'https://img2.baidu.com/it/u=2180749372,3204128823&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500',
      link: '',
      caption: '',
    },
    {
      imgUrl:
        'https://img0.baidu.com/it/u=296560967,1683617454&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500',
      link: '',
      caption: '',
    },
    {
      imgUrl:
        'https://img2.baidu.com/it/u=792038472,827733466&fm=253&fmt=auto&app=138&f=JPG?w=888&h=500',
      link: '',
      caption: '',
    },
    {
      imgUrl:
        'https://img2.baidu.com/it/u=2413717469,2574113709&fm=253&fmt=auto&app=138&f=JPEG?w=660&h=500',
      link: '',
      caption: '',
    },
    {
      imgUrl:
        'https://img0.baidu.com/it/u=3123983776,2678596163&fm=253&fmt=auto&app=138&f=JPEG?w=889&h=500',
      link: '',
      caption: '',
    },
  ];
